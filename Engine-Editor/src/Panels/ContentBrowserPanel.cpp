...
namespace eg
{
	...
	void ContentBrowserPanel::OnImGuiRender()
	{
		...
		if (m_CurrentDirectory != AssetDirectoryManager::getRootDirectoryUUID()) {
			...
			if (ImGui::ImageButton("ContentBrowser_Arrow", (ImTextureID)IconLoader::GetIcon(Icons::ContentBrowser_Arrow)->GetRendererID(), {30, 30}))
			{
		...
		drawList->ChannelsSplit(2);
		drawList->ChannelsSetCurrent(1);
		if(ImGui::ImageButton("ContentBrowser_Plus##xx",(ImTextureID)IconLoader::GetIcon(Icons::ContentBrowser_Plus)->GetRendererID(), ImVec2(30, 30)))
		{
