...
VULKAN_SDK_EXE_PATH = 'Engine/vendor/VulkanSDK/VulkanSDK.exe'
...
OutputDirectory = "Engine/vendor/VulkanSDK"

def CheckVulkanSDKDebugLibs():
    shadercdLib = Path(f"{OutputDirectory}/Lib/shaderc_sharedd.lib")
    if (not shadercdLib.exists()):
        print(f"You don't have the Vulkan SDK debug! (Muniffic requires {HAZEL_VULKAN_VERSION})")
