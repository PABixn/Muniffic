...
namespace eg {
	...
	private:
		...
		static std::unordered_map<UUID, FrameResourceData*> FrameResourceDataCache;
		...
		static std::unordered_map<UUID, ScriptResourceData*> ScriptResourceDataCache;
		static std::unordered_map<UUID, AudioResourceData*> AudioResourceDataCache;
		static std::unordered_map<UUID, SceneResourceData*> SceneResourceDataCache;
