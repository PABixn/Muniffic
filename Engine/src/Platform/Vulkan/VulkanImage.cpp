...
namespace eg {
    ...
    void VulkanImage::Load(VkDevice logicalDevice, VkPhysicalDevice physicalDevice, VkCommandPool commandPool, const std::string& path, uint32_t mipLevels)
    {
        ...
        VulkanBuffer::CreateBuffer(logicalDevice, physicalDevice, imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, pixels);

		Create(logicalDevice, texWidth, texHeight, mipLevels, VK_SAMPLE_COUNT_1_BIT, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);

		TransitionImageLayout(logicalDevice, commandPool, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, mipLevels);
		CopyBufferToImage(stagingBuffer, static_cast<uint32_t>(texWidth), static_cast<uint32_t>(texHeight));
		VulkanImage::GenerateMipMaps(physicalDevice, m_Image, VK_FORMAT_R8G8B8A8_SRGB, texWidth, texHeight, mipLevels);
    ...
    void VulkanImage::Destroy(VkDevice logicalDevice)
    {
        m_ImageView.Destroy(logicalDevice);
        vkDestroyImage(logicalDevice, m_Image, nullptr);
        VulkanDeviceMemoryManager::FreeMemory(m_ImageMemory);
    }

    void VulkanImage::GenerateMipMaps(VkPhysicalDevice physicalDevice, VkImage& image, VkFormat format, int32_t texWidth, int32_t texHeight, int32_t mipLevels)
    {
