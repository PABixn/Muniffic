...
{
	TransitionTextureLayout(VulkanTexture.m_TextureImage, format, oldLayout, newLayout);
}

void eg::TextureManager::TransitionTextureLayout(VkImage& texture, const VkFormat& format, const VkImageLayout& oldLayout, const VkImageLayout& newLayout)
{
